...
function App() {
  ...
  const [modal, setModal] = useState({ section: null, mode: null, content: null });


  function handleModalOpen(section, mode, content = null) {

    if (auth.token) {
      setModal({ section: section, mode: mode, content: content });
  ...
  function handleModalClose() {
    ...
    setModal({ section: null, mode: null, content: null });
  }
    ...
    <>
      <Routes>
        ...
        <Route element={<NavbarLayout />}>
          <Route path="/products" element={<ProductPage productList={productList} search={search} handleModalOpen={handleModalOpen} handleDelete={handleDelete} />} />
          <Route path="/stores" element={<StorePage storeList={storeList} search={search} handleModalOpen={handleModalOpen} handleDelete={handleDelete} />} />
          <Route path="/faqs" element={<FaqPage faqList={faqList} search={search} handleModalOpen={handleModalOpen} handleDelete={handleDelete} />} />
          <Route path="*" element={<Navigate to="/products" replace />} />
        </Route>
      </Routes>

      { isModalOpened && <Modal modal={modal} handleModalClose={handleModalClose} handleSubmit={handleSubmit} />}
    </>
